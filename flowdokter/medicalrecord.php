          ...
          <div class="medical-record-description-textarea">
            ...
            <div class="rekam-medis">
              ...
              <div>
                ...
                <textarea rows="6" name="utama" id="utama" placeholder="" class="formbold-form-input" disabled="disabled"><?= $hasilpemeriksaan["Diagnosa_utama"] ?></textarea>
              </div>

              <div>
                <label for="sekunder" class="formbold-form-label"> Diagnosa Sekunder (Komplikasi+Penyerta) : </label>
                <textarea rows="6" name="sekunder" id="sekunder" placeholder="" class="formbold-form-input" disabled="disabled"><?= $hasilpemeriksaan["Diagnosa_sekunder"] ?></textarea>
              </div>

              <div>
                <label for="namatindak" class="formbold-form-label"> Nama Operasi/Tindakan : </label>
                <textarea rows="6" name="namatindak" id="namatindak" placeholder="" class="formbold-form-input" disabled="disabled"><?= $hasilpemeriksaan["Tindakan"] ?></textarea>
              </div>

              <div>
                <label for="tindak" class="formbold-form-label"> Insturksi untuk tindak lanjut : </label>
                <textarea rows="6" name="tindak" id="tindak" placeholder="" class="formbold-form-input" disabled="disabled"><?= $hasilpemeriksaan["Instruksi_lanjutan"] ?></textarea>
              </div>

              <div>
                <label for="fisik" class="formbold-form-label"> Pemeriksaan Fisik : </label>
                <textarea rows="6" name="fisik" id="fisik" placeholder="" class="formbold-form-input" disabled="disabled"><?= $hasilpemeriksaan["Pemeriksaan_fisik"] ?></textarea>
              </div>

              <div>
                <label for="penunjang" class="formbold-form-label"> Hasil pemeriksaan penunjang : </label>
                <textarea rows="6" name="penunjang" id="penunjang" placeholder="" class="formbold-form-input" disabled="disabled"><?= $hasilpemeriksaan["Hasil_pemeriksaan_penunjang"] ?></textarea>
              </div>

              <div>
                <label for="note" class="formbold-form-label"> Catatan tambahan : </label>
                <textarea rows="6" name="note" id="note" placeholder="Isi jika ada catatan tambahan" class="formbold-form-input" disabled="disabled"><?= $hasilpemeriksaan["Catatan"] ?></textarea>
              </div>
              ...
              <div class="formbold-input-radio-wrapper">
                ...
                <div class="formbold-radio-flex">
                    ...
                    <?php foreach ($enumcarakeluar as $enum) : ?>
                      <div class="formbold-radio-group">
                        <label class="formbold-radio-label">
                          <input disabled="disabled" class="formbold-input-radio" type="radio" name="keluar" value="<?= $enum ?>" <?= $hasilpemeriksaan["Cara_keluar"] == $enum ? 'checked' : '' ?>>
                          <?= $enum ?>
                      ...
                      <!-- <div class="formbold-radio-group">
                    <label class="formbold-radio-label">
                      <input class="formbold-input-radio" type="radio" name="keluar" id="keluar" value="Diijinkan pulang" checked = 'checked'>
                      Diijinkan Pulang
                      <span class="formbold-radio-checkmark"></span>
                    </label>
                  </div>
                  ...
                  <div class="formbold-radio-group">
                    <label class="formbold-radio-label">
                      <input class="formbold-input-radio" type="radio" name="keluar" id="keluar">
                      Melarikan Diri
                      <span class="formbold-radio-checkmark"></span>
                    </label>
                  </div>
                  ...
                  <div class="formbold-radio-flex">
                    <div class="kumpulan-radio">
                      <?php foreach ($enumkondisi as $enumsikon) : ?>
                        <div class="formbold-radio-group">
                          <label class="formbold-radio-label">
                            <input disabled="disabled" class="formbold-input-radio" type="radio" name="kondisipasien" value="<?= $enumsikon ?>" <?= $hasilpemeriksaan["Kondisi_pasien"] == $enumsikon ? 'checked' : '' ?>>
                            <?= $enumsikon ?>
                        ...
                        <!-- <input class="formbold-input-radio" type="radio" name="kondisipasien" id="kondisipasien"> -->
                        <!-- <div class="formbold-radio-group">
                      <label class="formbold-radio-label">
                        <input class="formbold-input-radio" type="radio" name="kondisipasien" id="kondisipasien">
                        Membaik
                    ...
                    <div class="formbold-radio-flex">
                      <div class="kumpulan-radio">
                        <?php foreach ($enumkategori as $enumrawat) : ?>
                          <div class="formbold-radio-group">
                            <label class="formbold-radio-label">
                              <input disabled="disabled" class="formbold-input-radio" type="radio" name="kategori" id="kategori" value="<?= $enumrawat ?>" <?= $hasilpemeriksaan["kategori_pasien"] == $enumrawat ? 'checked' : '' ?>>
                              <?= $enumrawat ?>
                              <span class="formbold-radio-checkmark"></span>
                            </label>
                          </div>
                          ...
                          <!-- <div class="formbold-radio-group">
                  <label class="formbold-radio-label">
                    <input class="formbold-input-radio" type="radio" name="kategori" id="kategori">
                    Rawat Jalan
                    <span class="formbold-radio-checkmark"></span>
                  </label>
                </div> -->
